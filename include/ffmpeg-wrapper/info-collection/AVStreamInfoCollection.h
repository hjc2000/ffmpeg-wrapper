...
namespace video
{
    ...
    public:
        ...
        AVStreamInfoCollection(AVStreamInfoCollection const &o);
        AVStreamInfoCollection(AVStreamWrapper const &o);
        ~AVStreamInfoCollection();

        AVStreamInfoCollection &operator=(AVStreamInfoCollection const &o);
