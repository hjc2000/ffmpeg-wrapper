...
void video::InfinitePacketPipe::UpdateLastPacketDuration(int64_t value)
{
...
void video::InfinitePacketPipe::UpdateLastDts(int64_t value)
{
	if (value > _last_dts)
	{
		_last_dts = value;
...
void video::InfinitePacketPipe::CorrectStartingPointOfDts(AVPacketWrapper &packet)
{
...
void video::InfinitePacketPipe::SendData(AVPacketWrapper &packet)
{
	// packet 不为空指针
...
void video::InfinitePacketPipe::Flush()
{
